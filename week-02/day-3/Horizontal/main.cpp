...
void horizLine(std::pair<int, int> cord);
...
void horizLine(std::pair<int, int> cord)
{
    std::pair<int, int> endPoint{cord.first + 50, cord.second};
    SDL_SetRenderDrawColor( gRenderer, 0x00, 0xFF, 0x00, 0xFF );
    SDL_RenderDrawLine(gRenderer, cord.first, cord.second, endPoint.first, endPoint.second);
}
